...
3. Création d’un dépôt Etudiant sur GitHub pour le BE prog. C & réseau
   ...
   Créer une copie du dépôt template enseignant : XYZW , en vous y rendant et en cliquant sur le bouton « use this template » situé dans le coin en haut, plutôt à droite de la page. 
